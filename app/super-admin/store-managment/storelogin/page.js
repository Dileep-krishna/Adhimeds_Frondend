...
export default function StoreLoginPage() {
    ...
    // Dummy UI – no real form submission
    const handleDummySubmit = (e) => {
        e.preventDefault();
        // No login logic – just a demo alert
    ...
    return (
        <div className="container-fluid vh-100 p-0 overflow-hidden">
            <div className="row g-0 h-100">
                ...
                {/* RIGHT SIDE – Store Login Form (design only) */}
                <div className="col-12 col-lg-6 d-flex justify-content-center align-items-center bg-light p-4">
                    ...
                    >
                        <div className="card-body p-4 p-md-5">
                            ...
                            {/* Dummy form – no real submission */}
                            <form onSubmit={handleDummySubmit}>
                                <div className="mb-3 animate-fade-up delay-100">
                                    <label className="form-label fw-semibold">Store ID / Code</label>
